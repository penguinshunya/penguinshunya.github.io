...
void solve() {
  ...
  auto calc = [&](int u, int d, int l, int r) {
    return acc[d][r] - acc[d][l] - acc[u][r] + acc[u][l];
  };
  vector<vi32> ans(h, vi32(w));
  int index = 1;
  function<void(int, int, int, int)> rec = [&](int u, int d, int l, int r) {
    if (calc(u, d, l, r) == 1) {
      repi(i, u, d) repi(j, l, r) ans[i][j] = index;
      index++;
      return;
    }
    bool f = false;
    repic(i, u + 1, d - 1) {
      if (calc(u, i, l, r) > 0 && calc(i, d, l, r) > 0) {
        rec(u, i, l, r);
        rec(i, d, l, r);
        f = true;
        break;
    ...
    if (f) return;
    repic(i, l + 1, r - 1) {
      if (calc(u, d, l, i) > 0 && calc(u, d, i, r) > 0) {
        rec(u, d, l, i);
        rec(u, d, i, r);
        return;
      }
